...
const FAQS = [
  ...
  },
  {
    ...
    a_en: 'Under the Central Motor Vehicles Rules, you can apply for renewal up to one year before expiry and within one year after expiry without having to re-take the practical driving test. If renewal is requested after more than one year of expiry, a fresh driving test is required.',
    q_gu: 'સમાપ્ત થયેલ ડ્રાઇવિંગ લાઇસન્સ રિન્યૂ કરવા માટે ગ્રેસ પીરિયડ કેટલો છે?',
    a_gu: 'સેન્ટ્રલ મોટર વ્હીકલ નિયમો હેઠળ, તમે ફરીથી ડ્રાઇવિંગ ટેસ્ટ આપ્યા વિના સમાપ્તિના એક વર્ષ પહેલાં અને સમાપ્તિના એક વર્ષની અંદર રિન્યુઅલ માટે અરજી કરી શકો છો. જો એક વર્ષ કરતાં વધુ સમય પછી અરજી કરવામાં આવે, તો ફરીથી ટેસ્ટ આપવો જરૂરી છે.',
    q_hi: 'समाप्त ड्राइविंग लाइसेंस के नवीनीकरण के लिए छूट अवधि कितनी है?',
    a_hi: 'केंद्रीय मोटर वाहन नियमों के तहत, आप दोबारा टेस्ट दिए बिना समाप्ति से 1 वर्ष पहले और समाप्ति के 1 वर्ष के भीतर नवीनीकरण हेतु आवेदन कर सकते हैं। 1 वर्ष से अधिक समय बीत जाने पर पुनः टेस्ट देना अनिवार्य होता है।',
  },
  {
    id: 6,
    category: 'duplicate',
    q_en: 'What should I do if my Driving Licence is lost or stolen?',
    a_en: 'First, lodge an online or physical Police Lost Report / FIR with your nearest police station. Then, apply for a "Duplicate Driving Licence" on this portal with your FIR reference number, address proof, and identity proof. You will receive a fresh polycarbonate smart card with your original DL number.',
    q_gu: 'જો મારું ડ્રાઇવિંગ લાઇસન્સ ખોવાઈ જાય કે ચોરાઈ જાય તો મારે શું કરવું?',
    a_gu: 'પ્રથમ, નજીકના પોલીસ સ્ટેશનમાં પોલીસ લોસ્ટ રિપોર્ટ / FIR નોંધાવો. ત્યારબાદ, તમારા FIR સંદર્ભ નંબર, સરનામા અને ઓળખના પુરાવા સાથે આ પોર્ટલ પર "ડુપ્લિકેટ ડ્રાઇવિંગ લાઇસન્સ" માટે અરજી કરો.',
    q_hi: 'यदि मेरा ड्राइविंग लाइसेंस खो जाए या चोरी हो जाए तो मुझे क्या करना चाहिए?',
    a_hi: 'पहले नजदीकी थाने में पुलिस रिपोर्ट / FIR दर्ज कराएं। इसके बाद अपनी FIR संदर्भ संख्या, पते और पहचान प्रमाण के साथ इस पोर्टल पर "डुप्लीकेट ड्राइविंग लाइसेंस" हेतु आवेदन करें।',
  },
  {
    id: 7,
    category: 'fees',
